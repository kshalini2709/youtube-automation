...
OUTPUT_DIR = "single_link_pipeline/watermark"
os.makedirs(OUTPUT_DIR, exist_ok=True)


def watermark_single_video(
    input_video,
    text,
    text_size,          # expects 0.5 – 5
    text_opacity,
    text_x,             # base X (%)
    text_y,             # base Y (%)
    move_text=True,
    move_radius=6,      # float area (% of frame)
    top_logo_path=None,
    ...
    output = os.path.join(OUTPUT_DIR, f"{base}_wm.mp4")
